...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    phone_number = serializers.CharField(
        required=True,
        max_length=255,
        validators=[phone_validator, validators.UniqueValidator(queryset=User.objects.all())],
    )

    class Meta:
        model = User
        fields = ('first_name', 'last_name', 'username', 'password', 'password_confirmation', 'email', 'phone_number')
