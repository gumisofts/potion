...
AWS_CLOUD_ACCESS_KEY_ID = env("AWS_CLOUD_ACCESS_KEY_ID")
AWS_CLOUD_SECRET_ACCESS_KEY = env("AWS_CLOUD_SECRET_ACCESS_KEY")
AWS_CLOUD_STORAGE_BUCKET_NAME = env("AWS_CLOUD_STORAGE_BUCKET_NAME")
AWS_CLOUD_S3_REGION_NAME = env("AWS_CLOUD_S3_REGION_NAME", "eu-north-1")
AWS_CLOUD_REGION = AWS_CLOUD_S3_REGION_NAME
AWS_STORAGE_BUCKET_NAME = env("AWS_CLOUD_STORAGE_BUCKET_NAME")
